...
Truck.prototype.specific = function(loadWeight) {
  if(loadWeight > this.towingCapacity) {
...
const myTruck = new Truck ("Ford", "F150", 2020, 5000, "Red", "V8", 10000, "Gasoline","Automatic", 4, 6000);
/*
...
const car = new Car("Toyota","Tundra", 2019, 20000, "Red","V8", 10000,"Gasoline","Automatice", 4, 5600);
const boundDrive = Car.prototype.drive.bind(car);
...
function ElectricCar(brand, model, year, mileage, batteryCapacity) {
  ...
  if(new.target !== undefined && new.target !== ElectricCar){
